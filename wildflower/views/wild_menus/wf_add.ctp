...
<ul class="menu_items">
    <li>
        <?php echo $form->input('WildMenuItem.0.label', array('div' => array('class' => 'menu_item_label'))); ?>
        <?php echo $form->input('WildMenuItem.0.url', array('div' => array('class' => 'menu_item_url'))); ?>
