...
<ul class="list-of-posts">
    <?php foreach ($posts as $post) { ?>
        <li class="post-row">
            ...
            <span class="row-actions"><?php echo $html->link('View', WildPost::getUrl($post['WildPost']['uuid']), array('class' => 'permalink', 'rel' => 'permalink', 'title' => 'View this post in a new browser tab.')) ?></span>
            <?php
